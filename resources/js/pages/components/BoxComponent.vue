...
const boxColorClass = {
    1: 'bg-lime-200 hover:border-lime-400 text-lime-950',
    2: 'bg-yellow-200 hover:border-yellow-400 text-yellow-950',
...
<template>
    <Link :class="boxClass" :href="`/boxes/${number}`">
        <slot></slot>
        <p :class="sizeClass">{{ `[${size || 0}]` }}</p>
    </Link>
</template>
